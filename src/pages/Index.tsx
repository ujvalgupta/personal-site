    ...
    <Layout>
      <div className="min-h-[75vh] flex flex-col justify-center">
        <div className="space-y-6">
          ...
          <h1 className="text-6xl sm:text-7xl font-semibold tracking-tighter animate-fade-in stagger-2 leading-[0.9] -mt-1">
          ...
          <div className="pt-2 animate-fade-in stagger-5">
            <a
              href="/stuff"
